 ...
 *
 * Calls the ElevenLabs TTS API to generate MP3 files for all 39 clips
...
if (!apiKey && !dryRun) {
  ...
  console.error('Set it in the environment or in .env, then run node scripts/generate-transition-closing-audio.mjs');
  process.exit(1);
}
