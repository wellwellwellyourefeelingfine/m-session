 ...
 * - 15 pre-recorded TTS audio prompts
 * - Fixed duration (~4 minutes)
 * - No silence expansion (fixed pauses throughout)
 * - Audio-text sync via shared useMeditationPlayback hook
 *
 * Purpose: A quick grounding reset available at any point in the session.
 * Short enough to embed as a component of other modules or use as a
 * standalone 5-minute anchor when the user needs to come back to center.
 *
 * Tone: Simple and steady, grounding without being heavy, reassuring
 * without over-promising, present-focused.
 *
 * Voice: Oliver Silk (original recording)
 *
 * Duration breakdown:
...
export const shortGroundingMeditation = {
  id: 'short-grounding',
  title: 'Basic Grounding',
  subtitle: 'A quick reset',
  description: 'A brief guided audio meditation to come back to your body and the present moment. About four minutes.',

  // Audio configuration
  audio: {
    basePath: '/audio/meditations/short-grounding/',
    format: 'mp3',
    defaultVoice: 'theo',
    voices: [
