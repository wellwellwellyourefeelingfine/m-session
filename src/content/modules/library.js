...
export const FRAMEWORKS = {
  ...
  jungian:                 { label: 'Jungian / Guided Imagery',        abbreviation: null,  description: 'Working with archetypal imagery and the unconscious through guided inner journeys (active imagination, Leuner\'s Guided Affective Imagery).' },
...
export const MODULE_TYPES = {
  ...
  'metta-heart': { label: 'Metta Heart', intensity: 3 },
  'house-of-jung': { label: 'House of Jung', intensity: 4 },
  ...
  'centering-breath': { label: 'Centering Breath', intensity: 1 },
  ...
  // Intention Setting (pre-session) — MasterModule-based implementation
...
export const moduleLibrary = [
  ...
  {
    id: 'centering-breath',
    type: 'centering-breath',
    category: 'meditation',
    title: 'Centering Breath',
    description: 'A guided breath practice for settling, centering, and returning to yourself. Paced 4-in / 6-out breathing with soft orientation and a quiet close.',
    defaultDuration: 8,
    allowedPhases: ['pre-session', 'come-up', 'peak', 'integration'],
    recommendedPhases: ['pre-session', 'come-up'],
    hasVariableDuration: false,
    meditationId: 'transition-centering-breath',
    // Uses shared SimpleGroundingModule with audio-text sync; idle screen uses WaveLoop animation
    capabilities: {
      timer: { type: 'elapsed', showProgress: true, showTimeDisplay: true, autoComplete: true },
      prompts: { type: 'timed', fadeTransition: true },
      audio: { type: 'voiceover', showMuteButton: true },
    ...
    tags: ['breath', 'centering', 'calming', 'guided', 'pre-session', 'come-up'],
  ...
  },
  {
    ...
    category: 'meditation',
    title: 'Metta Heart',
    description: 'A guided loving-kindness meditation that builds warmth in the heart and radiates it outward — first to yourself, then to another, then without limit.',
    defaultDuration: 35,
    allowedPhases: ['pre-session', 'peak', 'integration'],
    recommendedPhases: ['come-up', 'peak'],
    hasVariableDuration: false,
    meditationId: 'metta-heart',
    // Uses custom MettaHeartModule with audio-text sync (fixed duration, silence-tuned)
    capabilities: {
      timer: { type: 'elapsed', showProgress: true, showTimeDisplay: true, autoComplete: true },
      prompts: { type: 'timed', fadeTransition: true },
      audio: { type: 'voiceover', showMuteButton: true },
    ...
    tags: ['meditation', 'metta', 'loving-kindness', 'heart-centered', 'guided'],
    framework: ['metta'],
    content: { instructions: 'A 35-minute audio-guided metta practice in ten phases. You\'ll settle the breath into the body and guide it to the heart center, then plant simple intentions for your own wellbeing — "May I be well. May I feel deep love. May I be filled with light." From there, the warmth spreads through the whole body, expands beyond the skin to include someone in your life, then radiates outward to all beings everywhere. The closing phases dissolve the sense of a sender and a receiver into a felt experience of boundlessness, then gently return you to the body. Best suited to peak or the deeper part of the come-up, when the heart is most open.' },
  },
  {
    id: 'house-of-jung',
    type: 'house-of-jung',
    ...
    description: 'A guided imagery journey through a familiar house, based on the archetypal semiotics theory of Carl Jung. Meet what lives beneath the rooms you usually live in.',
    defaultDuration: 45,
    allowedPhases: ['peak', 'integration'],
    recommendedPhases: ['peak'],
    hasVariableDuration: false,
    meditationId: 'house-of-jung',
    // Uses custom HouseOfJungModule with audio-text sync (fixed duration, silence-tuned)
    capabilities: {
      timer: { type: 'elapsed', showProgress: true, showTimeDisplay: true, autoComplete: true },
      prompts: { type: 'timed', fadeTransition: true },
      audio: { type: 'voiceover', showMuteButton: true },
    ...
    tags: ['meditation', 'jungian', 'guided-imagery', 'archetypal', 'shadow-work', 'guided'],
    framework: ['jungian'],
    content: { instructions: 'An extensive narrative audio-guided journey of inner descent and return, drawn from Jungian active imagination and Leuner\'s Guided Affective Imagery. Best suited to peak or early integration, when the system is open to projective imagery and can stay with intense material. The meditation draws on archetypal patterns and motifs, allowing the unconscious to fill in the narrative details with content that might be normally unavailable or avoided within the conscious mind.' },
  },
  {
    id: 'body-scan',
    type: 'body-scan',
